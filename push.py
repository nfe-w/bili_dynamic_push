...
class Push(object):
    ...
    def push_msg(self, uname=None, dynamic_id=None, content=None, dynamic_type=None):
        """
        推送
        :param uname: up主名字
        ...
        content = '[点我直达](https://t.bilibili.com/{dynamic_id})`{content}`'.format(dynamic_id=dynamic_id, content=content)
    ...
    def _server_chan(self, dynamic_id, title, content):
        ...
        response = requests.get(push_url, params={"text": title, "desp": content})
